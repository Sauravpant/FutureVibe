        ...
        >
          <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-10">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-[#0A1A2F] mb-2">Sign Up</h2>
              <p className="text-gray-600">Unlock your account</p>
            </div>

            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                <Label htmlFor="name" className="text-[#0A1A2F] font-semibold">
                  Name
                </Label>
            ...
            <div className="mt-8 text-center">
              <p className="text-gray-600">
                ...
                <Link href="/login" className="text-[#D4AF37] hover:text-[#E5C55C] font-semibold cursor-pointer">
                  Log in
                </Link>
              </p>
            </div>
